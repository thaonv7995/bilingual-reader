...
- 📥 **Xuất PDF hoàn chỉnh**: Ghép toàn bộ trang HTML EN/VI thành các file PDF A4 đã kiểm tra số trang, sau đó tải trực tiếp từ Book Studio.
...
* Để xuất sách, mở trang chi tiết của sách, chọn **Build PDFs**, rồi dùng thẻ **EN PDF** hoặc **VI PDF** để tải file hoàn chỉnh.
